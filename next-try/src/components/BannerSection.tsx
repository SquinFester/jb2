...
const BannerSection = () => {
  return (
    <section className="grid h-[94vh] w-full place-content-center place-items-center gap-10  bg-[url('/images/banner-bg.png')] bg-cover bg-center bg-no-repeat brightness-90 lg:bg-fixed">
